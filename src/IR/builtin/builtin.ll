...
define dso_local i32 @getInt() local_unnamed_addr #2 {
  ...
  %2 = call i32 (ptr, ...) @scanf(ptr noundef nonnull @.str.2, ptr noundef nonnull %1) #9
...
define dso_local noalias ptr @toString(i32 noundef %0) local_unnamed_addr #2 {
  ...
  %3 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %0) #9
  ret ptr %2
}
...
define dso_local i32 @string.length(ptr nocapture noundef readonly %0) local_unnamed_addr #5 {
  %2 = tail call i32 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
  ret i32 %2
}
...
define dso_local i32 @string.parseInt(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
  ...
  %3 = call i32 (ptr, ptr, ...) @sscanf(ptr noundef %0, ptr noundef nonnull @.str.4, ptr noundef nonnull %2) #9
...
define dso_local zeroext i1 @string.equal(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #9
  %4 = icmp eq i32 %3, 0
  ret i1 %4
}
...
attributes #9 = { "no-builtin-memcpy" "no-builtin-printf" }
